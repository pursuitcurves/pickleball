...
st.set_page_config(page_title="Pickleball Kim")
# st.header("")
# st.text("Know more about this new Internet Economy.")
...
class ChatbotWeb:
    ...
    def main(self):
        ...
        user_query = st.chat_input(placeholder="Ask me anything about Pickleball!")
        if user_query:
